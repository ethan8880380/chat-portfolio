          ...
          {hoverLinks.map((link, index) => (
            <a
              ...
              className={clsx(
                ...
                {
                  "lg:text-foreground/20": hoveredIndex !== index && hoveredIndex !== null,
                  "lg:text-foreground": hoveredIndex === index || hoveredIndex === null,
                },
              )}
            >
              ...
              <h3 className="text-5xl font-bold md:text-9xl lg:text-2xl">{link.heading}</h3>
              <motion.div
                className={clsx(
